...
echo "...done."
#
echo "Running 'SetupProject Gauss v49r7'"
SetupProject Gauss v49r7
echo "...done."
#
echo "Running 'setenvProject.sh Gauss v49r7 --user-area \$MOEDALDIR'"
setenvProject.sh Gauss v49r7 --user-area $MOEDALDIR
echo "...done."
#
## The location of the Gauss project.
echo "Declaring  NEWPROJECTPATH=$MOEDALDIR/Gauss_v49r7"
NEWPROJECTPATH=$MOEDALDIR/Gauss_v49r7
echo "...done."
#
...
cd ${NEWPROJECTPATH}
if [ -d "InstallArea" ]; then echo "<InstallArea> already exists"; else cp -r ${VO_MOEDAL_SW_DIR}/Gauss/Gauss_v49r7/InstallArea/ InstallArea; fi
if [ -d "Sim" ]; then echo "<Sim> already exists"; else cp -r ${VO_MOEDAL_SW_DIR}/Gauss/Gauss_v49r7/Sim/ Sim; fi
if [ -d "Gen" ]; then echo "<Gen> already exists"; else cp -r ${VO_MOEDAL_SW_DIR}/Gauss/Gauss_v49r7/Gen/ Gen; fi
