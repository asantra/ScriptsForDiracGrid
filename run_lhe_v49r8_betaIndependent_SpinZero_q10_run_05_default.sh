...
# files listed below.
gaudirun.py \
cfg_ganga_lhe_run_betaIndependent_SpinZero_q10_run_05_default.py \
${GAUSSOPTS}/Gauss-2016.py \
&> log.run.betaIndependent.SpinZero.q10.run_05.default.txt
...
echo "JOB_FINISHED" >> log.run.betaIndependent.SpinZero.q10.run_05.default.txt
echo "* Run complete!"
#
...
MINS=$(($MINS % 60))
SECS=$(($DIFF % 60))
echo "JOB TOOK:  ${HOURS} : ${MINS} : ${SECS}" >> log.run.betaIndependent.SpinZero.q10.run_05.default.txt
echo "*"
echo "* Total running time :  ${HOURS} h : ${MINS} m : ${SECS} s"
echo "*"
echo "* View the output messages with:"
echo "$ vim log.run.betaIndependent.SpinZero.q10.run_05.default.txt"
echo "*"
echo "* or inspect the results histograms with:"
echo "$ root -l MonopoleData_betaIndependent_SpinZero_q10_run_05_default.root"
echo "*"
echo
